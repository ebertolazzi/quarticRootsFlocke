...
namespace PolynomialRoots {
  ...
  static
  void
  QuadraticSyntheticDivision( indexType       NN,
                              valueType       u,
                              valueType       v,
                              valueType const p[],
                              valueType       q[],
